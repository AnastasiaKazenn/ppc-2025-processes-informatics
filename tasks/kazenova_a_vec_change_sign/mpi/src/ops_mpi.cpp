...
void KazenovaAVecChangeSignMPI::ComputeChunkBounds(int world_rank, int world_size, 
                                                    int total_size, int& start_idx, 
                                                    int& end_idx) {
...
int KazenovaAVecChangeSignMPI::CheckBoundary(int world_rank, int world_size, 
                                              int end_idx, int total_size) {
  if (world_rank >= world_size - 1) return 0;
